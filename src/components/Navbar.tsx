...
const Navbar = () => {
  const items = [
    { name: "Anasayfa", icon: <Home /> , link: "/"},
    { name: "Hakkımda", icon: <User2 />,link: "/about" },
    // { name: "Çalışmalarım", icon: <Layers />, link: "/projects" },
    { name: "Eğitim Ve İş Hayatım", icon: <Briefcase />, link: "/education" },
    { name: "İletişim", icon: <Phone />, link: "/contact" },
  ];
